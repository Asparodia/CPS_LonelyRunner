...
public class CharacterContract extends CharacterDecorator {
	...
	public void checkInvariant() {
		...
		boolean chara = (getDelegate().getEnvi().getCellContent(getDelegate().getWdt(), getDelegate().getHgt()))
				.isInside(getDelegate());
		if (!(chara)) {
			throw new InvariantError(
					"exist Character c in EnvironmentService::getCellContent(getEnvi()@pre,getWdt()@pre,getHgt()@pre) should implie c = this");
		}
	}
